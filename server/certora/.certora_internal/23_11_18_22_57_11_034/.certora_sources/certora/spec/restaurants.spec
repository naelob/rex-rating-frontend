...
rule checkStorageIsUpdated(
    ...
    total_restaurants = addRestaurant(_name, _postalAddress, _city, _country, _photoUrl, _latitude, _longitude);
    
    // Attempt to add another restaurant
    total_updated_restaurants = addRestaurant(_name, _postalAddress, _city, _country, _photoUrl, _latitude, _longitude);
